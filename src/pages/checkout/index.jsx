...
import veggies from "../../assets/veg_pizza.png"
import cocoCola from "../../assets/coke.png"
import checkoutLoc from "../../assets/addressD.png"
            ...
            <div className={styles.checkContainer}>
                <div className={styles.leftCheck}>
                    ...
                    <div className={styles.checkoutItems}>
                        <div className={styles.pizzaChic}>
                        ...
                        <div className={styles.veggiesPiz}>
                            <img src={veggies} alt="vegies" />
                            <div>
                        ...
                        <div className={styles.cokeDiet}>
                            <img src={cocoCola} alt="Drinks" />
                            <div>
                        ...
                        <div className={styles.checkInput}>
                            <p>Notes</p>
                            <input type="text" className={styles.inputText} placeholder="Add order notes" />
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.rightCheck}>
                    <div className={styles.addressCheck}>
                        <img src={checkoutLoc} alt="address logo" />
                        <div>
